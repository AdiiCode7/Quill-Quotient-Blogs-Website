...
const dbURI ="mongodb+srv://buniversity4:Adeel044@shariqadeel.6dniwds.mongodb.net/BlogsData?retryWrites=true&w=majority"
...
app.delete('/UserBlogDetail/:id', async (req, res) => {
  try {
    // const blogId = req.params.id;
    // console.log('Received request for blog ID to delete:', blogId);
